...
export abstract class JobSkillsRepository {
  abstract create(data: Omit<JobSkills, 'id' | 'created_at' | 'updated_at'>): Promise<JobSkills>;
  ...
  abstract update(id: JobSkills['id'], payload: DeepPartial<JobSkills>): Promise<JobSkills | null>;
